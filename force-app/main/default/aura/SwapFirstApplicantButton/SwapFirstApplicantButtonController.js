({ 
    doInit : function(component, event, helper) {
          ...
          var action = component.get("c.checkCoApplicant");
        action.setParams({
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                if(qt =='Co Applicant not Exist'){
                  
                var toast = $A.get("e.force:showToast");
                toast.setParams({
                    title: "Success",
                    message: "Co Applicant not Exist",
                    type: "success"
                });
                toast.fire();
     ...
     handleSwap : function(component, event, helper) {
        ...
        if (!reason || reason.trim() === '') {
            ...
            toast.setParams({
                title: "Error",
                message: "Please enter a Swaping Reason before submitting.",
                type: "error"
            });
            toast.fire();
            return;
